...
#Open the trace file
set tf [open log-reno-reno.tr w]
$ns trace-all $tf
...
proc finish {} {
	...
	set awkCode {
		...
		if ($5 == "tcp" || $5 == "ack"){
		    if ($8 == "1")
			print $1, $2, $3+1, $4+1, $5, $6, $11, $12 >> "tcp-reno-reno-1.tr"
		    else if ($8 == "2")
			print $1, $2, $3+1, $4+1, $5, $6, $11, $12 >> "tcp-reno-reno-2.tr"
		}
	    }
	}
	exec rm -f tcp-reno-reno-1.tr
	exec rm -f tcp-reno-reno-1.tr
	exec awk $awkCode log-reno-reno.tr
